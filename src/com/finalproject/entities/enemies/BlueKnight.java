...
public class BlueKnight extends StandardGameObject{
	...
	public void tick(){
		if(this.health > 0){
            ...
            if(Math.abs(this.player.x - this.x) > 500) dif = 0;
	...
	private void initImages(){
		...
		this.leftImages = new BufferedImage[4]; this.rightImages = new BufferedImage[this.leftImages.length];
