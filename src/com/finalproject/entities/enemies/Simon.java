...
public class Simon extends StandardGameObject{
	...
	private void initImages(){
		...
		this.leftImages = new BufferedImage[5]; this.rightImages = new BufferedImage[this.leftImages.length];
		this.attackLeftImages = new BufferedImage[3]; this.attackRightImages = new BufferedImage[this.attackLeftImages.length];
