...
public class Torch extends StandardGameObject {
    ...
    private StandardAnimator animator = null;
     ...
     *
     * redValue 86 = Small Blue Torch redValue 87 = Small Red Torch redValue 88
     * = Small Green Torch 89 = NULL (DOES NOT WORK; tried a different torch
     * image, but failed) 90 = Standard Torch 91 = NULL
     */
    public Torch(double x, double y, int redValue) {
        ...
        switch (redValue) {
            case 86:
                r = new Color(0x0000ff);
                break; //B
            case 87:
                r = new Color(0xff0000);
                break; //R
            case 88:
                r = new Color(0x00ff00);
                break; //G
            case 89:
                r = new Color(0xff0000);
                break;
            case 90:
                r = new Color(0xFFA500);
                break; //Orange
            default:
                System.err.println("R IS NOT VALID : " + redValue);
        }
    }
