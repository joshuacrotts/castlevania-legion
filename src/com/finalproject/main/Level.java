    ...
    public void loadLevelData() {
        ...
        for (int x = 0; x < w; x++) {
            for (int y = 0; y < h; y++) {
                 ...
                 * Table: 0 - Skeleton 1 - Richter 2 - Blue Knight 3 - Old
                 * Julius 4 - New Julius 5 - Simona 6 - Eagle 7 - Basic Zombie 8
                 * - Sword Man
                 */
                ...
                if (r <= 30 && g == 255 && b == 0) {
                    ...
                    if (r == 8) {
                        this.stdHandler.addEntity(new SwordMan(x * 32, y * 32, this.stdHandler, this.player));
                    }

                }

                /**
                 * OBJECT TESTING* Testing r values once again 86 - S Blue Torch
                 * 87 - S Red Torch 88 - S Green Torch 89 - NULL (nonworking
                 * sprite) 90 - Standard Torch 0 91 - Torch 1 (Candle class)
                 *
                 *
                 */
                ...
                /**
                 * BRICK TESTING** /* When r >= 230, we reserve g >= 100 && b >=
                 * 100 for bricks. /* G will represent y values, b will
                 * represent x values. /
                 */
                 ...
                 *
                 * b == 31 is Lava b == 32 128 b == 33 64 etc
                 */
                if (r > 30 && r <= 40 && g == 127 && b == 0) {
                    switch (r) {

                        case 31:
                            this.stdHandler.addEntity(new Lava(x * 32, y * 32, 1248, 32));
                            break;
