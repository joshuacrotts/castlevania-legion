...
public class Player extends StandardGameObject{
	...
	private BufferedImage duckL; private BufferedImage duckR;

	//Proprietary Images to Soma
	private BufferedImage[] jumpUpLeft = new BufferedImage[8]; private StandardAnimator jumps = null;
	...
	private BufferedImage[] hurtLeft = new BufferedImage[20]; private StandardAnimator hurtsL = null;
	private BufferedImage[] hurtRight = new BufferedImage[this.hurtLeft.length]; private StandardAnimator hurtsR = null;
	...
	public Player(double x, double y, Game g, StandardHandler enemyHandler){
		...
		this.meleeFight.bind(g.getKeyboard(), KeyEvent.VK_G);//Spawns the Melee Weapon currently in possession

		this.secondaryCmd.bind(g.getKeyboard(), KeyEvent.VK_C); //Spawns the Cross; similar to fireball
	...
	/**
	 * Initializes the animators for the object with the bufferedimage arrays passed into it with the appropriate delay.
