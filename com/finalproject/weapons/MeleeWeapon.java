...
public abstract class MeleeWeapon extends StandardGameObject{
	...
	//Images
	public ArrayList<BufferedImage> leftWeapons = null; public StandardAnimator lefts = null;
	public ArrayList<BufferedImage> rightWeapons = null; public StandardAnimator rights = null;
	...
	/**
	 * Make SURE you add this method in your subclass; it needs to initialize and 
	 * load in the images for the image. 
	 * 
	 * It also HAS to initialize the StandardAnimations. PASS IN THE OBJECT THAT IT IS; NOT
	 * THE PLAYER. Made that mistake myself lol
	 */
		...
		if(this.player.usingMelee){
			if(this.player.lastDir == Direction.Left){
				if(lefts.getFrame() != lefts.images.size()-1){
					...
					this.player.usingMelee = false; return;
