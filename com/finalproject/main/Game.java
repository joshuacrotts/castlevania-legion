...
public class Game extends StandardGame implements KeyListener{
    ...
    public enum GAME_STATE {Menu, Paused, Game, Transition};
    public static GAME_STATE gameState = GAME_STATE.Menu;

    public boolean paused = false;
    public boolean fp = true;
    public boolean firstPass = true; public boolean musicFirstPass = true;
...
//    	}
    ...
    private void initLevels(){
    	...
    	/**
    	 * Hard coded levels  && music
    	 * Volume levels go between 0.0 and 1.0 inclusive.
    	 * 
    	 * Using adjustFXVolume takes in a positive or negative number; the default value of
    	 * volume is 1, so if you wanted the volume to be 70% quieter, do adjustFXVolume(-0.7);
    	 * the new volume per the file will be 0.3.
    	 */
    	 
    	Game.music[0] = new StandardAudio("res/audio/music/level5.mp3", false); music[0].adjustFXVolume(-0.7);
    ...
    /**
     * I just finally included the KeyListener interface because your Command/Input framework
     * wasn't working properly; I would press P to pause, then it would work sometimes, othertimes
     * it would just unpause immediately.
     */
	@Override
	public void keyPressed(KeyEvent e) {
		...
		case KeyEvent.VK_P: this.paused = true;
